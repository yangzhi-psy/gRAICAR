function null_interSb_reproMap = generateNullRepro_worker (fn, numIter, workerID)
...
% save tmp result
fn = sprintf ('%s_null_interSb_reproMap_%d.mat', obj.setup.outPrefix, workerID);
save (fn, 'null_interSb_reproMap');

% update computing core log
fn = fullfile (obj.setup.outDir, 'distComp.log');
prog = load (fn, '-ascii'); 
prog = prog+1;
save (fn, 'prog', '-ascii');