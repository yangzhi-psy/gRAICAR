...
fprintf (fid, '\t\t\t<td><img src="%s" align="left" width="334" height="250" border="0"></a></td>\n', fn);
fn = sprintf ('subjLoad_AC%d.png', comp);
fprintf (fid, '\t\t\t<td><img src="%s" align="left" width="250" height="250" border="0"></a></td>\n', fn);
...
fprintf (fid, '\t<h3 align="center">Automatically Generated by gRAICARg</h3>\n');
fprintf (fid, '</body>\n');
fprintf (fid, '</html>\n');
fclose (fid);
end